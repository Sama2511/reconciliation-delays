...
def query_1(df_clean, start_date, end_date, journal_achat, journal_codes):
    factures = df_clean[
...
def query_2(df_clean, start_date, end_date, start_year, journal_achat, journal_codes):
...
def query_3(df_clean, start_date, end_date, start_year, journal_achat, journal_codes):
    start_date_minus_1 = start_date - datetime.timedelta(days=1)
...
def query_4(df_clean, df_clean_past, start_date, end_date, start_year, journal_achat, journal_report_nouveau, journal_codes):
...
"""RN not paid yet"""
def query_5(df_clean, df_clean_past, end_date, start_year, journal_achat, journal_report_nouveau, journal_codes):
    factures_AN = df_clean[
        (df_clean['journal'].isin(journal_report_nouveau)) &
        (df_clean['montant_credit'].notna()) &
        (df_clean['montant_credit'] > 0) &
